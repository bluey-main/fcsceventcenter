  ...
  return (
    <div className={`w-full lg:h-[40vh] h-[60vh] bg-orange-500 flex lg:flex-row flex-col ${playfair_display.className}`}>
      <div className="flex-1 bg-[#E9C7DA] h-full p-8">
        <div className="w-full h-full  flex justify-center  gap-y-3 flex-col px-6">
        ...
        <p className="text-base">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente illo error magni! Delectus.</p>
        </div>
