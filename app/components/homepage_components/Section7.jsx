...
const Section7 = () => {
  return (
    <div className="w-full h-[70vh] bg-slate-500 bg-[url('/images/event3.jpg')] bg-cover mt-10">
        <div className="w-full h-full bg-[#000000a8] flex flex-col justify-center items-center text-white gap-y-10 px-6">
          <p className={`lg:text-6xl text-4xl ${playFair.className} text-center`}>Unlock Connection & Excitement</p>
          <p className={`lg:text-2xl text-xl ${playFair.className} text-center lg:px-60`}>Join Now to Experience Exclusive Events, Thriving Friendships, and Unforgettable</p>
