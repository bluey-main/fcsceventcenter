  ...
  return (
    <div>
      <div className="w-full min-h-screen bg-red-">
        ...
        <div className="w-full lg:h-[30rem] h-[50rem] bg-yellow flex lg:px-40 lg:flex-row justify-center items-center flex-col lg:pt-0 pt-10">
        ...
        <div className="w-full lg:h-[30rem] h-[50rem] bg-yellow- flex lg:px-40 lg:flex-row-reverse flex-col lg:pt-0 pt-10">
          <div className="lg:w-[40%] w-full lg:h-full h-[30%] lg:px-0 px-7 bg-red- flex justify-center flex-col gap-y-6">
            <p className={` lg:text-6xl text-5xl lg:text-right text-left text-[#a12f27ff]  ${playFair.className}`}>Drinks</p>
            <p className='lg:text-xl text-lg text-left lg:text-right'>
              Get ready to feast at our Bar and Grill&apos;s food spot!
              We&apos;re dishing out all your grill cravings and throwing in
              some local vibes too. From classics to hometown faves, our
              menu&apos;s stacked with flavor. Join us for a laid-back, tasty
